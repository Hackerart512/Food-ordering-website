        ...
        <div className='login-div'>
          ...
          <form onSubmit={handleSubmit} method="POST" action="http://localhost:5000/api/admin/login">
            <div  className='inputclass'>
              <input style={{width:'286px'}} onChange={handleChange}  name="username" placeholder="Username" type="email" className='inp inp1 inp2' />
            </div>

            <div   className='inputclass'>
              <input style={{width:'286px'}} onChange={handleChange}  name="password" placeholder="Password" type="password" className='inp inp1 inp2' />
            </div>
